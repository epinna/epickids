# Epic Kids, a Phaser Editor example game

![game snapshot](.github/sunny-land-snapshot.png)

This started as a port to Phaser 3 of the [Sunny Land demo made by Luis Zuno](https://ansimuz.itch.io/sunny-land-pixel-game-art) and is being evolved into the Epic Kids platformer.
